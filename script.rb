...
def question_2
  loop do
  puts "\n"
  puts "What is the name of the elected bodies in the US that make up the Legislative branch who make the laws?"
...
def question_3
  loop do
  puts "\n"
  puts "What is the name of the highest elected office of the Executive branch, and US government? (Case Sensitive)"
